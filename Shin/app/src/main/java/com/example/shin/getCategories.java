...
public class getCategories extends AppCompatActivity {
    private RecyclerView recyclerView;
    private ProgressBar mProgressCircle;
    private DatabaseReference ProductsRef,CategoryRef;
    private String categorie="",catP="";
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<Products> options=new FirebaseRecyclerOptions.Builder<Products>()
                .setQuery(ProductsRef.orderByChild("category").equalTo(categorie),Products.class)
                .build();
        FirebaseRecyclerAdapter<Products, ProductViewHolder> adapter=new FirebaseRecyclerAdapter<Products, ProductViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull ProductViewHolder holder, final int i, @NonNull final Products products) {
                catP=products.getCategory();
                if(catP.equals(categorie))
                {
                    ...
                    holder.itemView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Intent intent=new Intent(getCategories.this,ProductDetailsActivity.class);
